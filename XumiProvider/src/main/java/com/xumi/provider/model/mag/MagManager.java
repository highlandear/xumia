...
public class MagManager {
	...
	public void load() {
		...
		this.add(new MagData("4", paths[2], "精美生肖家园物品", "边顶", "https://www.cognitivelab.net/question.html")
				.addItem(m[3]));
	}
	...
	public java.util.List<MagData> getMagList() {
